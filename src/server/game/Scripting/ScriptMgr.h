...
class TC_GAME_API UnitScript : public ScriptObject
{
    ...
    public:
        ...
        virtual void ModifyHealRecieved(Unit* /*healer*/, Unit* /*target*/, uint32& /*heal*/) { } //autobalance
...
class TC_GAME_API AllCreatureScript : public ScriptObject
{
    ...
    // Called at the end of creature update
        virtual void OnAllCreatureUpdate(Creature* /*creature*/, uint32 /*diff*/) { } //autobalance
};
...
class TC_GAME_API ScriptMgr
{
    ...
    public: /* AllCreatureScript */
        ...
        void OnCreatureUpdateAll(Creature* creature, uint32 diff); //autobalance
    ...
    public: /* UnitScript */
        ...
        void ModifyHealRecieved(Unit* healer, Unit* target, uint32& heal);  //autobalance
